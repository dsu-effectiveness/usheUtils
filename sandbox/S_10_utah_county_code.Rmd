...
s_10_utah_county_code_real_df <- get_data_from_sql_file(file_name="s_10.sql",
                             dsn="edify")
...
format_s_10_utah_county_code <- function(input_df) {
...
```{r}
DT::datatable(format_s_10_utah_county_code(s_10_utah_county_code_real_df), rownames=FALSE)
```
